...
public final class DummyServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.dummy.DummyMessage,
      com.example.dummy.DummyMessage> getDummyHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DummyHello",
      requestType = com.example.dummy.DummyMessage.class,
      responseType = com.example.dummy.DummyMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.dummy.DummyMessage,
      com.example.dummy.DummyMessage> getDummyHelloMethod() {
    io.grpc.MethodDescriptor<com.example.dummy.DummyMessage, com.example.dummy.DummyMessage> getDummyHelloMethod;
      ...
      synchronized (DummyServiceGrpc.class) {
        if ((getDummyHelloMethod = DummyServiceGrpc.getDummyHelloMethod) == null) {
          DummyServiceGrpc.getDummyHelloMethod = getDummyHelloMethod =
              io.grpc.MethodDescriptor.<com.example.dummy.DummyMessage, com.example.dummy.DummyMessage>newBuilder()
  ...
  public static abstract class DummyServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void dummyHello(com.example.dummy.DummyMessage request,
        io.grpc.stub.StreamObserver<com.example.dummy.DummyMessage> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.dummy.DummyMessage,
                com.example.dummy.DummyMessage>(
  ...
  public static final class DummyServiceBlockingStub extends io.grpc.stub.AbstractStub<DummyServiceBlockingStub> {
    ...
    /**
     */
    public com.example.dummy.DummyMessage dummyHello(com.example.dummy.DummyMessage request) {
  ...
  public static final class DummyServiceFutureStub extends io.grpc.stub.AbstractStub<DummyServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.dummy.DummyMessage> dummyHello(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DUMMY_HELLO:
          serviceImpl.dummyHello((com.example.dummy.DummyMessage) request,
              (io.grpc.stub.StreamObserver<com.example.dummy.DummyMessage>) responseObserver);
          break;
        default:
  ...
  private static abstract class DummyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.dummy.DummyProto.getDescriptor();
    }
